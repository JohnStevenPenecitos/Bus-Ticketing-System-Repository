...
<html>
  ...
  <body>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Bookings</a><a class="item " href="transactions.php">Transactions</a><a class="active item" href="travelclass.php">Traveling Classes</a>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Travel Classes</h1>
         </div>
