...
<html>
  ...
  <body>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Bookings</a><a class="item active" href="transactions.php">Transactions</a>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Received Transactions</h1>
         </div>
        <div class="ui horizontal divider">Transactions Details</div>      
		<div class="row">
