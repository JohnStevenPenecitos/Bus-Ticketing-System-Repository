...
<html>
  ...
  <body> 
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="active item" href="bookings.php">Bookings</a><a class="item" href="transactions.php">Transactions</a><a class="item" href="travelclass.php">Traveling Classes</a>
	...
	<div class="ui grid">
         ...
         <h1 class="ui huge header">Bookings</h1></div>
        <div class="ui horizontal divider"> Booking Details </div>      
		<?php 
//rejection
...
{$order=$row['order_ref'];
echo("<tr><td>".$row['order_ref']."</td><td>".$row['fullname']."</td><td>".$row['contact']."</td><td>".$row['class_reserved']."</td><td>".$row['destination']."</td><td>".$row['seats_reserved']."</td><td>".$row['date_reserved']."</td><td><a class='ui tiny button blue' href='bookings.php?reject=$order'>Reject</a></td></tr>");
}		
}
else{
