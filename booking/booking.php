...
<div class="ui unstackable tiny steps">
  <div class="step" onclick="booking()">
    ...
    <div class="content">
      ...
      <div class="description">Booking Info</div>
    </div>
  </div>
  ...
  <div class="disabled step" id="billingbtn" onclick="billing()">
   ...
   <div class="disabled step" id="finishbtn">
    <i class="icon info"></i>
    <div class="content">
      <div class="title">Finishing</div>
      <div class="description">Ticket Verification</div>
    </div>
  </div>
</div>
</div>
...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>ALABANG to TUTUBAN</option>
      <option>SUCAT  to BLUEMENTRITT</option>
	   <option>BICUTAN to PACO</option>
	    <option>FTI to EDSA</option>
      <option>NICHOLS  to BUENDIA</option>
	   <option>EDSA to PACO</option>
	    <option>PASAY ROAD to PANDACAN</option>
    </select>
  </div>   
  </div>
<div class="field">  
 ...
 <div class="field">
    <select name="gender" required id="travelclass">
      <option value="" selected disabled>Bus Classes</option>
...
<form class="ui form attached fluid loading segment" onsubmit="return billing(this)">
    <div class="field">
      ...
      <input placeholder="Full name" type="text" id="fullname" autocomplete="off">
    </div>

  <div class="field">
    <label>Contact/Mobile or Email address</label>
    <input placeholder="Mobile No/Contact or Email address" type="text" id="contact" autocomplete="off">
  </div>
...
<div class="ui icon input">
  <input placeholder="Transaction Code" type="text" required id="codebox" autocomplete="off">
  <i class="payment icon"></i>
</div>
</div>

<label>Confirm Amount(₱)</label>
<select name="transacationid" required id="amount">
      <option value="" selected disabled>Select Classes</option>
      <option value="Ordinary - 50">Ordinary - ₱50</option>
      <option value="Fair - 60">Fair - ₱60</option>
    </select>
    <div class="field">
    </div> 
...
<b>Before proceeding, please re-check the following details you have provided</b><br>
<br>
<div class="ui horizontal divider">Details Provided</div>
<div id="details"></div>
<div class="ui horizontal divider">Confirm Details</div>
<div class="ui fluid container center aligned">
<a class="ui button green" onclick="senddata()">CONFIRM</a>
</div>
</div>
</div>
